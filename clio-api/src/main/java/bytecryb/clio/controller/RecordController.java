...
public class RecordController {
    ...
    public ResponseEntity<Record> approveRecord(@RequestParam(value = "id") Long id,
        ...
        if (userId != -1) {
            ...
            //update related Job's last indexed field
            relatedJob.setLastIndexed(new Timestamp(System.currentTimeMillis()));
            ...
            // check if user has a badge, if not check if their score is greater than or
            // equal to badge's required score
