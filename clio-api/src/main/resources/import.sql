...
INSERT INTO roles (id, rolename) VALUES (2, 'veteran');
...
INSERT INTO users (id, username, email, password, role_id, first_name, last_name) VALUES (2, 'veteran', 'veteran@email.com', '$2a$10$wKA2CWgUb0k8ew37ttCVj.khlDVRmZyYfAMHVaIsR1iEkhNVCv/fW', (SELECT id FROM roles WHERE rolename = 'veteran'), 'First', 'Veteran');
